    ...
    openSourceProjects = [
        {
            ...
            description:
                'The code for this portfolio website, built with Angular and Bootstrap. It is deployed using Vercel.',
            technologies: [
                'Angular',
                'Bootstrap',
                'TypeScript',
    ...
    workProjects = [
        {
            ...
            description:
                'A web-based UI for managing and visualizing BPMN workflows in Camunda 7.',
            technologies: [
                'Angular',
                'Cypress',
                'Playwright',
        ...
        },
        {
            ...
            description:
                'A REST API that provides additional capabilities on top of the existing task resources in the Camunda 7 platform.',
            technologies: [
                'Node.js',
                'NestJS',
                'Kubernetes',
